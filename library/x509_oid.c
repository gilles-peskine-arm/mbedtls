...
FN_OID_TYPED_FROM_ASN1(mbedtls_x509_oid_descriptor_t, certificate_policies, oid_certificate_policies)
 ...
 */
#if defined(MBEDTLS_X509_USE_C) || defined(MBEDTLS_X509_CRT_WRITE_C) || defined(MBEDTLS_X509_CSR_WRITE_C)
typedef struct {
    mbedtls_x509_oid_descriptor_t    descriptor;
