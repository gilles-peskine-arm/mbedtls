...
static const oid_sig_alg_t oid_sig_alg[] =
{
    ...
    {
        OID_DESCRIPTOR( MBEDTLS_OID_HYBRID_DSA_SHA256,    "hybrid-with-SHA256",     "HYBRID with SHA256" ),
        MBEDTLS_MD_SHA256,    MBEDTLS_PK_HYBDSA,
    },
    {
        OID_DESCRIPTOR( MBEDTLS_OID_HYBRID_DSA_SHA384,    "hybrid-with-SHA384",     "HYBRID with SHA384" ),
        MBEDTLS_MD_SHA384,    MBEDTLS_PK_HYBDSA,
    },
    {
        OID_DESCRIPTOR( MBEDTLS_OID_HYBRID_DSA_SHA512,    "hybrid-with-SHA512",     "HYBRID with SHA512" ),
        MBEDTLS_MD_SHA512,    MBEDTLS_PK_HYBDSA,
    },
#endif /* MBEDTLS_PQ_C */
    {
        NULL_OID_DESCRIPTOR,
...
FN_OID_GET_ATTR2(mbedtls_oid_get_sig_alg, oid_sig_alg_t, sig_alg, mbed_md_alg_e, md_alg, mbed_hybpk_t, pk_alg)
FN_OID_GET_OID_BY_ATTR2(mbedtls_oid_get_oid_by_sig_alg, oid_sig_alg_t, oid_sig_alg, mbed_hybpk_t, pk_alg, mbed_md_alg_e, md_alg)
#endif /* MBEDTLS_MD_C */
...
static const oid_pk_alg_t oid_pk_alg[] =
{
  ...
  #ifdef MBEDTLS_PQ_C
    {
        OID_DESCRIPTOR( MBEDTLS_OID_KYBER_ALG,           "Kyber",            "Kyber KEM" ),
        MBEDTLS_PK_KYBER,
    },
    {
        OID_DESCRIPTOR( MBEDTLS_OID_DILITHIUM_ALG,       "Dilithium",        "Dilithium DSA" ),
        MBEDTLS_PK_DILITHIUM,
    },
    {
        OID_DESCRIPTOR( MBEDTLS_OID_DILITHIUM_ALG_PUB,   "Dilithium-pubkey", "Dilithium public key" ),
        MBEDTLS_PK_DILITHIUM,
    },
    {
        OID_DESCRIPTOR( MBEDTLS_OID_MULTI_PKCS8,        "hybrid-pkcs8",     "Hybrid key" ),
        MBEDTLS_PK_MULTI,
    },
  #endif 
    {
...
FN_OID_GET_ATTR1(mbedtls_oid_get_pk_alg, oid_pk_alg_t, pk_alg, mbed_hybpk_t, pk_alg)
FN_OID_GET_OID_BY_ATTR1(mbedtls_oid_get_oid_by_pk_alg, oid_pk_alg_t, oid_pk_alg, mbed_hybpk_t, pk_alg)
...
static const oid_ecp_grp_t oid_ecp_grp[] =
{
    ...
    {
        OID_DESCRIPTOR( MBEDTLS_OID_EC_GRP_CURVE25519, "x25519",    "x25519" ),
...
FN_OID_GET_ATTR1(mbedtls_oid_get_md_alg, oid_md_alg_t, md_alg, mbed_md_alg_e, md_alg)
FN_OID_GET_OID_BY_ATTR1(mbedtls_oid_get_oid_by_md, oid_md_alg_t, oid_md_alg, mbed_md_alg_e, md_alg)
...
FN_OID_GET_ATTR1(mbedtls_oid_get_md_hmac, oid_md_hmac_t, md_hmac, mbed_md_alg_e, md_hmac)
#endif /* MBEDTLS_MD_C */
...
FN_OID_GET_ATTR2(mbedtls_oid_get_pkcs12_pbe_alg, oid_pkcs12_pbe_alg_t, pkcs12_pbe_alg, mbed_md_alg_e, md_alg, mbedtls_cipher_type_t, cipher_alg)
