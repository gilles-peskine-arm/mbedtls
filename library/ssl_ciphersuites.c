...
#undef HAVE_SHA256              /* Have SHA-256 ciphersuites? */
#undef HAVE_SHA384              /* Have SHA-386 ciphersuites? */
...
static const mbedtls_ssl_ciphersuite_t ciphersuite_definitions[] =
{
...
#endif /* MBEDTLS_GCM_C */
#endif /* HAVE_SHA384 */
#if defined(MBEDTLS_CCM_C) && defined(MBEDTLS_SSL_PROTO_TLS1_2)
    ...
    { MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_128_CCM_8, "TLS-ECDHE-ECDSA-WITH-AES-128-CCM-8",
      ...
      MBEDTLS_SSL_MAJOR_VERSION_3, MBEDTLS_SSL_MINOR_VERSION_3,
      MBEDTLS_CIPHERSUITE_SHORT_TAG },
#endif /* MBEDTLS_CCM_C && MBEDTLS_SSL_PROTO_TLS1_2 */
#endif /* MBEDTLS_AES_C */
    ...
    { MBEDTLS_TLS_RSA_WITH_ARIA_256_CBC_SHA384,
      ...
      0 },
#endif
#if (defined(MBEDTLS_GCM_C) && defined(HAVE_SHA256))
    { MBEDTLS_TLS_RSA_WITH_ARIA_128_GCM_SHA256,
      ...
      0 },
#endif
#if (defined(MBEDTLS_CIPHER_MODE_CBC) && defined(HAVE_SHA256))
    { MBEDTLS_TLS_RSA_WITH_ARIA_128_CBC_SHA256,
