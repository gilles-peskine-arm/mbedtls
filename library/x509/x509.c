 ...
 */
static int x509_get_hash_alg( const mbedtls_x509_buf *alg, mbed_md_alg_e *md_alg )
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    unsigned char *p;
...
int mbedtls_x509_get_rsassa_pss_params( const mbedtls_x509_buf *params,
                                mbed_md_alg_e *md_alg, mbed_md_alg_e *mgf_md,
                                int *salt_len )
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    unsigned char *p;
...
int mbedtls_x509_sig_alg_gets( char *buf, size_t size, const mbedtls_x509_buf *sig_oid,
                       mbed_hybpk_t pk_alg, mbed_md_alg_e md_alg,
                       const void *sig_opts )
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    char *p = buf;
