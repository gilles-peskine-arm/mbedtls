...
const char * mbedtls_high_level_strerr( int error_code )
{
    ...
    switch( high_level_error_code )
    {
        ...
        case -(MBEDTLS_ERR_ECP_TYPE_MISMATCH):
            return( "ECP - ECP key type mismatch" );
#endif /* MBEDTLS_ECP_C */
        ...
        case -(MBEDTLS_ERR_PK_INCOMPATIBLE_ALGO):
            return( "PK - Try to add an incompatible algortihm to the top key " );
        case -(MBEDTLS_ERR_PK_INTERNAL_ERROR):
            return( "PK - Incorrect code implementation " );
        case -(MBEDTLS_ERR_PK_DECAP_ERROR):
            return( "PK - Secret key decapsulation error" );
        case -(MBEDTLS_ERR_PK_ENCAP_ERROR):
            return( "PK - Public key encapsulation error" );
        case -(MBEDTLS_ERR_PK_NUM_KEYS_ERROR):
            return( "PK - Number of keys in the hybrid key error" );
#endif /* MBEDTLS_PK_C */
