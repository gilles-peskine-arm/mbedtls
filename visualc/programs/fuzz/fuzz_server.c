...
int LLVMFuzzerTestOneInput(const uint8_t *Data, size_t Size) {
    ...
    if (initialized == 0) {
        ...
        mbed_pk_init( &pkey, dummy_random, dummy_entropy, pers );
        ...
        if (mbedtls_x509_crt_parse( &srvcert, (const unsigned char *) mbedtls_test_cas_pem,
            ...
            return 1;
        if (mbed_pk_parse_prvkey( pkey, (const unsigned char *) mbedtls_test_srv_key, mbedtls_test_srv_key_len, NULL, 0) != 0)
            return 1;
#endif
