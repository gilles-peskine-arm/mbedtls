...
#ifdef MBEDTLS_PQ_C
 #define MBEDTLS_TLS_PQKEM_PQDSA_WITH_AES_256_GCM_SHA384      0xD02C  // test value 
 #define MBEDTLS_TLS_HYBKEM_HYBDSA_WITH_AES_256_GCM_SHA384    0xE02C  // test value 
#endif 

/* Reminder: update mbedtls_ssl_premaster_secret when adding a new key exchange.
 * Reminder: update MBEDTLS_KEM__xxx below
 */
typedef enum {
    MBEDTLS_KEM_NONE = 0,
    MBEDTLS_KEM_RSA,
    MBEDTLS_KEM_DHE_RSA,
    MBEDTLS_KEM_ECDHE_RSA,
    MBEDTLS_KEM_ECDHE_ECDSA,
    MBEDTLS_KEM_PSK,
    MBEDTLS_KEM_DHE_PSK,
    MBEDTLS_KEM_RSA_PSK,
    MBEDTLS_KEM_ECDHE_PSK,
    MBEDTLS_KEM_ECDH_RSA,
    MBEDTLS_KEM_ECDH_ECDSA,
    MBEDTLS_KEM_ECJPAKE,
#ifdef MBEDTLS_PQ_C  
    MBEDTLS_KEM_PQKEM_PQDSA,    // test value 
    MBEDTLS_KEM_HYBKEM_HYBDSA,  // test value 
#endif // MBEDTLS_PQ_C
...
/* Key exchanges using a certificate */
    ...
    defined(MBEDTLS_KEM_DHE_RSA_ENABLED)       || \
...
#define MBEDTLS_KEM_WITH_CERT_ENABLED
#endif
...
/* Key exchanges allowing client certificate requests */
    ...
    defined(MBEDTLS_KEM_ECDH_ECDSA_ENABLED)    ||       \
    defined(MBEDTLS_KEM_ECDHE_ECDSA_ENABLED)
#define MBEDTLS_KEM_CERT_REQ_ALLOWED_ENABLED
#endif
...
/* Key exchanges involving server signature in ServerKeyExchange */
    ...
    defined(MBEDTLS_KEM_ECDHE_RSA_ENABLED)     || \
    defined(MBEDTLS_KEM_ECDHE_ECDSA_ENABLED)
#define MBEDTLS_KEM_WITH_SERVER_SIGNATURE_ENABLED
#endif

/* Key exchanges using ECDH */
#if defined(MBEDTLS_KEM_ECDH_RSA_ENABLED)      || \
    defined(MBEDTLS_KEM_ECDH_ECDSA_ENABLED)
#define MBEDTLS_KEM_SOME_ECDH_ENABLED
#endif
...
/* Key exchanges that don't involve ephemeral keys */
    ...
    defined(MBEDTLS_KEM_RSA_PSK_ENABLED)       || \
    defined(MBEDTLS_KEM_SOME_ECDH_ENABLED)
#define MBEDTLS_KEM_SOME_NON_PFS_ENABLED
#endif
...
#define MBEDTLS_KEM_SOME_PFS_ENABLED
#endif
...
/* Key exchanges using a PSK */
    ...
    defined(MBEDTLS_KEM_DHE_PSK_ENABLED)       || \
    defined(MBEDTLS_KEM_ECDHE_PSK_ENABLED)
#define MBEDTLS_KEM_SOME_PSK_ENABLED
#endif

/* Key exchanges using DHE */
#if defined(MBEDTLS_KEM_DHE_RSA_ENABLED)       || \
    defined(MBEDTLS_KEM_DHE_PSK_ENABLED)
#define MBEDTLS_KEM_SOME_DHE_ENABLED
#endif
...
/* Key exchanges using ECDHE */
    ...
    defined(MBEDTLS_KEM_ECDHE_ECDSA_ENABLED)   || \
    defined(MBEDTLS_KEM_ECDHE_PSK_ENABLED)
#define MBEDTLS_KEM_SOME_ECDHE_ENABLED
#endif

typedef struct mbedtls_ssl_ciphersuite_t mbedtls_ssl_ciphersuite_t;
typedef struct mbedtls_ssl_ciphersuite_t ssl_suite_t;  
...
struct mbedtls_ssl_ciphersuite_t
{
    ...
    mbed_md_alg_e          MBEDTLS_PRIVATE(mac);
    mbedtls_kem_type_t     MBEDTLS_PRIVATE(key_exchange);
...
typedef struct mbedtls_ssl_ciphersuite_t ssl_ciphersuite_t;
...
mbed_hybpk_t mbedtls_ssl_get_ciphersuite_sig_pk_alg( const mbedtls_ssl_ciphersuite_t *info );
mbed_hybpk_t mbedtls_ssl_get_ciphersuite_sig_alg( const mbedtls_ssl_ciphersuite_t *info );
mbed_hybpk_t mbedtls_ssl_get_ciphersuite_kem_pk_alg( const mbedtls_ssl_ciphersuite_t *info );
#endif
