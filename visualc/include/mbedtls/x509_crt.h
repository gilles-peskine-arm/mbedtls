...
typedef struct mbedtls_x509_crt
{
    ...
    mbed_pktop_t    *MBEDTLS_PRIVATE(pktop);             /**< Pointer to the public key context. */
    ...
    mbed_md_alg_e MBEDTLS_PRIVATE(sig_md);           /**< Internal representation of the MD algorithm of the signature algorithm, e.g. MBEDTLS_MD_SHA256 */
    mbed_hybpk_t MBEDTLS_PRIVATE(sig_pk);           /**< Internal representation of the Public Key algorithm of the signature algorithm, e.g. MBEDTLS_PK_RSA */
...
typedef struct mbedtls_x509_crt_profile
{
    ...
    uint32_t min_nist_level;    /**< Minimum MIST security level */
}
...
typedef struct mbedtls_x509write_cert
{
    ...
    mbed_pktop_t *MBEDTLS_PRIVATE(subject_key);
    mbed_pktop_t *MBEDTLS_PRIVATE(issuer_key);
    mbedtls_asn1_named_data *MBEDTLS_PRIVATE(subject);
    mbedtls_asn1_named_data *MBEDTLS_PRIVATE(issuer);
    mbed_md_alg_e MBEDTLS_PRIVATE(md_alg);
 ...
 */
void mbedtls_x509write_crt_set_subject_key( mbedtls_x509write_cert *ctx, mbed_pktop_t *key );
 ...
 */
void mbedtls_x509write_crt_set_issuer_key( mbedtls_x509write_cert *ctx, mbed_pktop_t *key );
 ...
 */
void mbedtls_x509write_crt_set_md_alg( mbedtls_x509write_cert *ctx, mbed_md_alg_e md_alg );
