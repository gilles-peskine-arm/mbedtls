...
typedef struct mbedtls_rsa_context
{
    ...
    int MBEDTLS_PRIVATE(hash_id);                /*!< Hash identifier of mbed_md_alg_e type,
    ...
    void   *key_params;  // opaque pointer (TODO, move rsa.h from API level to rsa private include) 
