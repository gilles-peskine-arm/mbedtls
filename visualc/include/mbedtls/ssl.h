...
#ifdef MBEDTLS_PQ_C 
 #define MBEDTLS_SSL_SIG_PQ                   4
 #define MBEDTLS_SSL_SIG_HYBRID               5
#endif 
...
struct mbedtls_ssl_session
{
    ...
    mbed_md_alg_e MBEDTLS_PRIVATE(peer_cert_digest_type);
 ...
 *                 You may use mbed_pk_check_pair() in order to perform
