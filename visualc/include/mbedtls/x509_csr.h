...
typedef struct mbedtls_x509_csr
{
    ...
    mbed_pktop_t     *MBEDTLS_PRIVATE(pktop_ref);    /**< reference to the public key context. */
...
{
    // mbed_pktop_t *MBEDTLS_PRIVATE(key);
    void *MBEDTLS_PRIVATE(pktop);                /**< reference to the public key context. */
 ...
 *
 * \param ctx       CSR context to use
 * \param pktop_ref Asymetric key to include
 */
void mbedtls_x509write_csr_set_key( mbedtls_x509write_csr *ctx, mbed_pktop_t *pktop_ref );
 ...
 */
void mbedtls_x509write_csr_set_md_alg( mbedtls_x509write_csr *ctx, mbed_md_alg_e md_alg );
