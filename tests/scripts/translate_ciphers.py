...
def translate_gnutls(s_cipher):
    ...
    # Replace "_" with "-" to handle ciphersuite names based on MbedTLS
    # naming convention
...
def translate_ossl(s_cipher):
    """
    Translate s_cipher from Mbed TLS ciphersuite naming convention
...
def translate_mbedtls(s_cipher):
    """
    Translate s_cipher from Standard ciphersuite naming convention
    and return MbedTLS ciphersuite naming convention
    """
