...
check tests/scripts/generate_psa_tests.py tests/suites/test_suite_psa_crypto_not_supported.generated.data test_suite_psa_crypto_storage_format.v0.data
