...
component_test_default_no_deprecated () {
    ...
    msg "test: make, default + MBEDTLS_DEPRECATED_WARNING" # ~ 5s
    make test
}
...
component_test_deprecated () {
    msg "build: make, full config + MBEDTLS_DEPRECATED_WARNING" # ~ 30s
    scripts/config.py full
    scripts/config.py set MBEDTLS_DEPRECATED_WARNING
    make CC=gcc CFLAGS='-O -Werror -Wall -Wextra -Wno-error=deprecated-declarations' lib programs
