 ...
 *  compression functionlimits the security of generated
 ...
 *                      function in the CTR_DRBG Instanciate Process
 *                      described in NIST SP 800-57A §10.2.1.3.2
 ...
 *                        In this case, for compliance with SP 800-57A,
 *                        you must pass a unique value of \p custom at
 *                        each invocation. See SP 800-57A §8.6.7 for more
 *                        details.
 *
 ...
 *
 * \note                For compliance with NIST SP 800-57A, the entropy length must be least
 *                      1.5 times security strength, since the entropy source is used both as the entropy input and to provide the initial nonce:
