 ...
 * random generator and an accelerator for some cryptographic algorithm,
 * include `psa/crypto_rng_driver.h` and `psa/crypto_accelerator_driver.h`.
 *
