...
struct psa_key_custom_production_s {
 ...
 * with `custom=PSA_KEY_CUSTOM_PRODUCTION_INIT` and `custom_data_length=0` is
 ...
 */
/* This is a deprecated variant of `struct psa_key_custom_production_s`.
 ...
 * `const struct psa_key_custom_production_s*`.
 */
