/**
 * \file psa/crypto_enum.h
 *
 * \brief PSA cryptography module: Integer encodings.
 *
 * \note This file may not be included directly. Applications must
 * include psa/crypto.h. Drivers must include the appropriate driver
 * header file.
 *
 * This file contains portable definitions of integral types and
 * macros to build and analyze values of these types. The types
 * concerned are properties of cryptographic keys, designations of
 * cryptographic algorithms, and error codes returned by the library.
 *
...
#ifndef PSA_CRYPTO_ENUM_H
#define PSA_CRYPTO_ENUM_H
